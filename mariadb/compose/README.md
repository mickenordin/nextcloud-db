...
* [Service Control](#service-control)
  * [Bootstrapping the MariaDB Cluster (3 or more nodes)](#bootstrapping-the-mariadb-cluster-3-or-more-nodes)
  * [Bootstrapping a one-node MariaDB cluster](#bootstrapping-a-one-node-mariadb-cluster)
  * [Shutting down the MariaDB cluster](#shutting-down-the-mariadb-cluster)
  * [Starting the cluster after an ungraceful shutdown](#starting-the-cluster-after-an-ungraceful-shutdown)
  * [Restarting a MariaDB node](#restarting-a-mariadb-node)
  * [Starting a MariaDB node with forced SST](#starting-a-mariadb-node-with-forced-sst)
* [Connecting to the MariaDB Server](#connecting-to-the-mariadb-server)
  * [Networking and ports](#networking-and-ports)
  * [Administrator user](#administrator-user)
  * [Application user](#application-user)
  * [Management using GUI](#management-using-gui)
* [Health Checks & Monitoring](#health-checks--monitoring)
  * [Cluster Integrity](#cluster-integrity)
...
* [Upgrade & Downgrade](#upgrade--downgrade)
  ...
  * [Minor version downgrade](#minor-version-downgrade)
  * [Major version downgrade](#major-version-downgrade)
